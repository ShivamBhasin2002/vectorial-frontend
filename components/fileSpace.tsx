...
const FileSpace: React.FC<FileSpaceProps> = ({ productId }) => {
  ...
  useEffect(() => {
    const fetchProductDetails = async () => {
      ...
      try {
        const productDetails = await dataStorageAccessor.getProductById(
          productId
        );
      ...
      if (product) {
        ...
        if (fileUri) {
          const updatedProduct = {
            ...product,
            [isTranscript ? "interviewTranscripts" : "fileUris"]:
              fileUris.filter((_, index) => index !== fileIndex),
          };
      ...
      >
        ...
        >
          ...
          {isTranscriptsOpen &&
            (product &&
            product.interviewTranscripts &&
            product.interviewTranscripts.length > 0 ? (
              ...
              >
                <p>
                  No interview transcripts uploaded. Please upload interview
                  transcripts.
                </p>
              </div>
            ))}
